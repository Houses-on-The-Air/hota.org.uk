<section class="container">
        ...
        <h3 id="best-time-to-operate">What is the best time to operate in HOTA?</h3>
        <p>The best time to operate in HOTA depends on band conditions and your location.</p>
        <h3 id="log-activations">How do I log my HOTA activations?</h3>
